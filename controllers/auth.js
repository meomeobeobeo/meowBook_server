...
export const signIn = async (req, res) => {
    ...
    try {
        ...
        const tokenId = jwt.sign({ email: existingUser.email, id: existingUser._id }, process.env.hashPassword, {
            expiresIn: '1h',
        })
...
export const signUp = async (req, res) => {
    ...
    try {
        ...
        const theNewUser = await Users.create({
            email: email,
        ...
        const tokenId = jwt.sign({ email: theNewUser.email, id: theNewUser._id }, process.env.hashPassword, {
            expiresIn: '1h',
        })
